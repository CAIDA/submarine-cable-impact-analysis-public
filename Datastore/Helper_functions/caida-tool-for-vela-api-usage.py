...
##
#############################################################################
## This script has been copied from http://www.caida.org/projects/ark/vela/web-api/
## Author: Young Huyn, author of the Vela API.
## We use it here to run traceroutes measurements with the said API
